...
const Tag = styled.span`
    background: #E0E7FF; /* Indigo muito claro */
...
export default function SurveysHero() {
    return (
        <HeroWrapper>
            <HeroContainer>
                <Tag>Pesquisas & NPS</Tag>
                <Title>Descubra o que os pais<br/><span>realmente pensam.</span></Title>
                <Subtitle>
                    Meça a satisfação de alunos e responsáveis com pesquisas de NPS e CSAT
                    disparadas por WhatsApp, E-mail ou link público. Antecipe cancelamentos
